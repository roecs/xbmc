...
//    entries.push_back(make_pair(VS_SCALINGMETHOD_NEDI             , ?????));
    ...
    entries.push_back(make_pair(VS_SCALINGMETHOD_DS_BILINEAR      , 16323));
    entries.push_back(make_pair(VS_SCALINGMETHOD_DS_BICUBIC_60    , 16324));
    entries.push_back(make_pair(VS_SCALINGMETHOD_DS_BICUBIC_75    , 16325));
    entries.push_back(make_pair(VS_SCALINGMETHOD_DS_BICUBIC_100   , 16326));
